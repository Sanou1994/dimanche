...
login=()=>{
  const apiUrl = 'https://rawade.herokuapp.com/api/authentification/';
 ...
 componentDidMount(){
  ...
  render() {
    if(this.state.etat){
      ...
      return <Redirect to='/journaloperation'/>;
    }
    else{
                  ...
                  <Card className="p-4 bg-white text-info">
                    ...
                    <CardBody>
                      <Form>
                        ...
                        <Row>
                          <Col xs="6">
                            <Button color="info"onClick={this.login.bind(this)} className="px-4 text-white">Connexion</Button>
                          </Col>
