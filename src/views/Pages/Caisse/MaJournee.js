...
class MaJournee extends Component {
    ...
    constructor(){
        super();
        this.state = {rendor:'',close:false,journee:{caisse:0,orange:0,expresso:0,freeMoney:0,wari:0,wizall:0,proximo:0,xpress:0,yup:0,wave:0,cloturer:0,sommeinitiale:0,date:"",idU:0}}
    ...
    componentDidMount(){
        ...
        const apiUrl = 'https://rawade.herokuapp.com/api/soldeDebuterJournees/caissier/'+idU;
        fetch(apiUrl)
