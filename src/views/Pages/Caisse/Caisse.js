...
constructor(props){
    super(props);
    this.state = {render:'',caisse1:[],caisse2:[],caisse:[],isLoad:false,url:'https://rawade.herokuapp.com/api/',
...
componentDidMount(){
    ...
    var idU=JSON.parse(localStorage.getItem('logaccorde'))[0].id;
    this.handleClick();
    const apiUrl = 'https://rawade.herokuapp.com/api/transactions/caissier/'+idU;
    var somme=0;
    ...
    fetch(apiUrl)
     ...
     var somme2=0;
     const apiUrl2 = 'https://rawade.herokuapp.com/api/soldeDebuterJournees/caissier/'+idU;
     fetch(apiUrl2)
     .then((response) => response.json())
...
update=()=>{
     const apiUrl = 'https://rawade.herokuapp.com/api';
     var idU=JSON.parse(localStorage.getItem('logaccorde'))[0].id;
...
handledelete(){
    console.log("ok...........!!!! id: "+this.state.id);
        axios.delete('https://rawade.herokuapp.com/api/transactions/supprimer/'+this.state.id)
        .then(
            res=>{
...
handleTrieoperateur(){
    ...
    const apiUrl = 'https://rawade.herokuapp.com/api/transactions/caissier/'+idU+'/recherche/operateur/'+$("#trie option:selected").text();
    var somme=0;
    var sommeDecaissement=0;
    var sommeEncaissement=0;
    var sommeComm=0;
...
handleTrieoperation(){
    ...
    const apiUrl = 'https://rawade.herokuapp.com/api/ransactions/caissier/'+idU+'/recherche/operation/'+$("#trieoperation option:selected").text();
   var somme = 0;
   var sommeDecaissement=0;
   var sommeEncaissement=0;
   var sommeComm=0;
        ...
        <div class="row">
            ...
            <div class="col-md-4 ">
                ...
                <form class="form-inline">
                    ...
                        <option   value="4">Expresso</option>
                        ...
                        <option value="12">entrées</option>
                        <option value="13">sorties</option>
                    </select>
            ...
            <div class="col-md-4 ">
                ...
                    <option value="2">decaissement</option>
                    <option value="3">plafonnement</option>
                    <option value="4">déplafonnement</option>
                  </select>
