...
handleEncaiss=(e)=>{
  ...
  if($('#operationval').val()=="plafonnement"){
  ...
  }else if($('#operationval').val()=="Entrée"){
    data={operateur:$('#operateurval').val(),operation:$('#operationval').val(),decaissement:0 ,
    commission:0,encaissement:0,frais:$('#frais').val(),taxe:0,montant: $('#montant').val(),surplux:0,numero:numero,
  ...
  axios.post('https://rawade.herokuapp.com/api/transactions/ajouter',data);
        ...
        <div class="card text-white bg-dark">
          ...
          <div class="card-body">
            <form>
              ...
              <div class="form-group">
                <span onClick={this.handleEncaiss.bind(this)} class="form-check-label" class="btn btn-lg btn-success">Valider</span>
              </div>
